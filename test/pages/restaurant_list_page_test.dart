...
void main() {
  testWidgets('4. Verify RestaurantListPage renders title and subtitle text correctly', (WidgetTester tester) async {
    // Setup a dummy SharedPreferences for ThemeProvider
    SharedPreferences.setMockInitialValues({});
    final preferencesHelper = PreferencesHelper(sharedPreferences: SharedPreferences.getInstance());

    // Build our app and trigger a frame.
    await tester.pumpWidget(
      MultiProvider(
        providers: [
          ChangeNotifierProvider(create: (_) => ThemeProvider(preferencesHelper: preferencesHelper)),
