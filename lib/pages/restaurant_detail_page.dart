        ...
        actions: [
          Consumer2<RestaurantDetailProvider, FavoriteProvider>(
            builder: (context, detailProvider, favoriteProvider, child) {
              ...
              if (state is ResultStateHasData<RestaurantDetailResponse>) {
                final restaurantDetail = state.data.restaurant;
                ...
                return IconButton(
                  ...
                  onPressed: () {
                    ...
                    if (isFavorited) {
                      favoriteProvider.removeFavorite(restaurantDetail.id);
                    } else {
